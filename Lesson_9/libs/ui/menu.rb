...
module Menu
  ...
  ROUTES_MENU = [
    ...
    {
      title: 'Добавить станцию к маршруту',
      answer: '3',
      callback: :add_station_to_route
    },
    {
      title: 'Удалить промежуточную остановку',
      answer: '4',
      callback: :remove_station_from_route
    },
    { title: 'Назад', answer: '0', break: true }
  ].freeze
  ...
  def train_edit
    ...
    show_menu(
      TRAIN_MENU,
      "Редактирование поезда #{train.number}",
      TrainController.new(train, @routes)
    )
  end
end
